...
TEST_F(ZimArchive, validate)
{
  ...
  // XXX: This test started failing. It was discovered during conflict
  // XXX: resolution during a rebase operation. The source of the problem
  // XXX: may belong to an earlier commit.
  //TEST_BROKEN_ZIM_NAME(
